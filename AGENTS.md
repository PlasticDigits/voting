...
**Suggested implementation order:** ledger (#1, from DEX #509) → `operator-voting` (#2, from DEX #510) → dApp (#3, from DEX #511) with BSC treated as **core** (#4, from DEX #588), not a later extra. Legal gate and wallet reuse are required for the dApp, not optional polish. Post-merge Coolify / Legal admin / live QA / POST limits: [#7](https://gitlab.com/PlasticDigits/voting/-/issues/7) · [`docs/OPS.md`](docs/OPS.md). Legal return: [#8](https://gitlab.com/PlasticDigits/voting/-/issues/8). Registered holders shown as 0: [#9](https://gitlab.com/PlasticDigits/voting/-/issues/9). Structured template: [#10](https://gitlab.com/PlasticDigits/voting/-/issues/10) · OV-S. Draft lifecycle and freeze-at-open: [#11](https://gitlab.com/PlasticDigits/voting/-/issues/11) · OV-D · [`skills/AGENTS_DRAFT_REVIEW.md`](skills/AGENTS_DRAFT_REVIEW.md). WalletConnect pairing: [#12](https://gitlab.com/PlasticDigits/voting/-/issues/12). Governance research: [#13](https://gitlab.com/PlasticDigits/voting/-/issues/13). Registration pending: [#14](https://gitlab.com/PlasticDigits/voting/-/issues/14) · L12. EVM Legal in-app hint: [#16](https://gitlab.com/PlasticDigits/voting/-/issues/16) · L-EVM · [`skills/AGENTS_LEGAL_CLICKWRAP.md`](skills/AGENTS_LEGAL_CLICKWRAP.md). Live dApp rebuild after !11 copy: [#17](https://gitlab.com/PlasticDigits/voting/-/issues/17).
